...
<form:form action="edit.htm" modelAttribute="userCus">
				...
				<div class="col-md-3 border-right">
					<div
						...
						<img class="rounded-circle mt-5" width="150px"
							...
							class="font-weight-bold">${ userCus.customer.khachhang_name }</span><span
							class="text-black-50">${ userCus.users_username }</span><span>
						</span>
					</div>
				</div>
					...
					<div class="p-3 py-5">
						...
						<div class="row mt-3">
							...
							<div class="col-md-12">
								...
								<form:input path="customer.khachhang_sdt" type="text"
								...
								<form:input path="role.role_id" type="text"
									...
									<%-- <form:select path="role.role_id">
										<c:forEach var="item" items="${ view_role }" begin="0"
											...
											<form:option value="${ item.role_name }"></form:option>
										</c:forEach>
									</form:select> --%>
							</div>
							<div class="col-md-12">
