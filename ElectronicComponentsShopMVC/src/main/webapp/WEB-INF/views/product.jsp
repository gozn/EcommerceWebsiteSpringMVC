				...
				<div class="container">
					...
					<div class="row">
						<div class="col-sm-6 col-sm-offset-3">
							<h2 class="module-title font-alt">All Products</h2>
						</div>
					</div>
					...
					<div class="row multi-columns-row">
						<c:if test="${ all_product.size() == 0}">
							<div class="col-md-6 col-md-3 col-lg-3">
								<h4>Không có sản phẩm ${message}</h4>
							</div>
						</c:if>
						<c:if test="${ all_product.size() != 0}">
							<c:forEach var="item" items="${all_product}" begin="0"
								...
								<div class="col-sm-3 col-md-3">
									<div class="shop-item">
											<img  style="width: 200px; height: 200px;" src="assets/images/shop/${item.product_images }"
						...
						<div class="col-sm-12">
							<div class="pagination font-alt">
								...
								<c:forEach var="item" begin="1" end="${ page }">
									<c:choose>
										<c:when test="${ item == 1 }">
											<a class="active" href="pages/${ item }.htm">${ item }</a>
										</c:when>
										<c:otherwise>
											<a href="pages/${ item }.htm">${ item }</a>
										</c:otherwise>
									</c:choose>
